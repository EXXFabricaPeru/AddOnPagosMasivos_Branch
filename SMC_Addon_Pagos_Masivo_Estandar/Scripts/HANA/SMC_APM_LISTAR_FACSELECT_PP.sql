...
BEGIN
	...
	WHERE 
		T0."Indicator" IN ('00','01','02','08','14','50','99','05','91')
	...
	SELECT
		...
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."Account") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'')
		AS "Cuenta",
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'') 
		AS "CuentaMoneda",
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T0."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",'SOL') = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'')
		AS "BankCode",
		(CASE 
			WHEN DAYS_BETWEEN(T0."DocDueDate", :fechaVenc) < 0 THEN 0 
	...
	FROM 
		...
		--LEFT JOIN OCRB T4 ON T0."CardCode" = T4.CardCode
	WHERE 
		T0."Indicator" IN ('00','01','02','08','14','50','99','05','07','91')
		--T0."Indicator" IN ('01','02','03','08','DT','DO')
		AND T1."InstlmntID" = '1'
		--AND T1.Status = 'O'
		AND T2."PymntGroup" not like '%DT%'
	...
	FROM
		...
		--LEFT JOIN OCRB T4 ON T0."CardCode" = T4.CardCode
	WHERE 
		T0."Indicator" IN ('00','01','02','08','14','50','99','05','07','DI','91')
		--T0."Indicator" IN ('01','02','03','08','DT','DO')
		AND T1."InstlmntID" = '1'
		AND T0."CreateTran" = 'Y'
		--AND T1.Status = 'O'
...
SELECT
	...
	WHERE 
		...
		*/
		...
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."Account") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."U_EXM_INTERBANCARIA") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'')
		AS "Cuenta",
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."UsrNumber1") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'') 
		AS "CuentaMoneda",
		IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(
		IFNULL(
		(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" /*AND "BankCode" = :tipoBanco*/ AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '011' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '002' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y')) 
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '009' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '022' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,(SELECT MAX(R0."BankCode") FROM OCRB R0 WHERE R0."CardCode" = T3."CardCode" AND "BankCode" = '003' AND (IFNULL(R0."UsrNumber1",:moneda) = :moneda)and "U_EXC_ACTIVO" = 'Y'))
		,'')
		AS "BankCode",
		(CASE 
